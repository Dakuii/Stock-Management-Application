...
urlpatterns = [
    ...
    path('register/', user_view.register, name='utilisateur-register'),
    path('profile/', user_view.profile, name='utilisateur-profile'),
    path('profile/update/', user_view.profile_update, name='utilisateur-profile-update'),
    path('', user_view.custom_login, name='utilisateur-login'),
    path('logout/',auth_views.LogoutView.as_view(template_name='user/logout.html'), name='utilisateur-logout'),
